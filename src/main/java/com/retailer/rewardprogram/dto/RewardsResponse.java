...
/**
 * Represents the reward points information for a customer.
 * This includes monthly points and the total points earned.
 */
public class RewardsResponse {
    ...
    /**
     * Constructs a RewardsResponse object with the provided customer ID, monthly points, and total points.
     * 
     * @param monthlyPoints the list of reward points earned by the customer for each month
