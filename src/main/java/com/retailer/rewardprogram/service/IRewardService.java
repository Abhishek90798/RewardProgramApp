...
/**
 * Interface for managing reward calculations for customers.
 * It provides methods to calculate reward points based on transactions.
 */
public interface IRewardService {
     ...
     * @return a RewardsResponse object containing the monthly points and total points for the customer
     */
     ...
     *
     * @return a list of RewardsResponse objects, each containing the monthly points and total points for each customer
     */
